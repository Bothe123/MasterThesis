...
Left of the dashed red line the probability density is comparatively small, as this area captures only events that had a change time since the beginning of observation, which is exceedingly rare for growing $t_a$, because as discussed in Sec. \ref{sec:forwardWaiting} the rate of steps decreases with time for $\gamma$.
